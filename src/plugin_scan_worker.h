 ...
 * worker half, and the ONLY place a scan loads plugin code (VST3
 * everywhere, AudioUnit on macOS — §11). PluginHostService (the
 * coordinator) enumerates candidate files itself, then re-launches its
 * own executable as
 *
