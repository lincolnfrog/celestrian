...
| [sequencer.md](sequencer.md) | spec + journal | The fractal Sequence primitive on stacks: the **period law** (§2 — a stack's effective period is window ▸ active sequence length ▸ LCM of children's effective periods, i.e. the composition law), gate/cue entrances, record-into-a-step, cue steps, successor graphs + the seed (§14 — the PROGRAM, root-only radios). Rulings S1–S22. Build steps 1–5 shipped. |
